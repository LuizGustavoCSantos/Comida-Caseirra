...
<head>
   ...
   <title>Arualizar Perfil Admin</title>
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="confirm_pass" maxlength="20" placeholder="Confirmar Nova Senha" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
